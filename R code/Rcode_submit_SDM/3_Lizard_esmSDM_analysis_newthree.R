...
for (limit in c(3500,3700)) {
 ...
 #limit=3700
  ...
  head(hab_change)
  hab_change<-hab_change[hab_change$Adaptation=="No",]
  ...
  for (pop in c("Low","High")) {
    ...
    ggsave(fig_change,file=paste("E:/QT/SDM/",limit,"m/SDM_Group/Fig_Habitatchanges_",pop,"_only.pdf",sep=""),device = "pdf",height=4,width=12,dpi = 300)
